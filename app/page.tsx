...
const works = [
  ...
  ["/media/style-dark-updo.jpg", "Собранный вечер", "вечерняя форма"],
  ["/media/work-evening.jpg", "Гладкий финиш", "укладка"],
  ["/media/work-blonde-crop.jpg", "Чистый блонд", "тон и уход"],
  ["/media/work-braid-crop.jpg", "Плетение", "деталь образа"],
  ["/media/work-kids.jpg", "Детская стрижка", "спокойный визит"],
  ["/media/color-crop.jpg", "Сложный цвет", "окрашивание"],
];
